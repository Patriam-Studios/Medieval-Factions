    ...
    override fun onCommand(sender: CommandSender, command: Command, label: String, args: Array<out String>): Boolean {
        ...
        val view = PaginatedView.fromChatComponents(
            ...
            listOf(
                ...
                arrayOf(TextComponent(plugin.language["CommandFactionHelpFactionHeir"]).apply { color = SpigotChatColor.GRAY }),
                ...
                arrayOf(TextComponent(plugin.language["CommandFactionHelpFactionTransfer"]).apply { color = SpigotChatColor.GRAY }),
